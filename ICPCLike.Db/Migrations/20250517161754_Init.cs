        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_stages_seasons_season_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_substitutions_persons_new_contestant_id",
                        column: x => x.new_contestant_id,
                        principalTable: "persons",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_substitutions_persons_old_contestant_id",
                        column: x => x.old_contestant_id,
                        principalTable: "persons",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_substitutions_teams_team_id",
                        column: x => x.team_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_team_members_persons_contestant_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_results_stages_stage_id",
                        column: x => x.stage_id,
                        principalTable: "stages",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_results_teams_team_id",
                        column: x => x.team_id,
                        principalTable: "teams",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_results_stage_id",
                table: "results",
                column: "stage_id");

            migrationBuilder.CreateIndex(
                name: "IX_results_team_id",
                table: "results",
                column: "team_id");

            migrationBuilder.CreateIndex(
                name: "IX_stages_season_id",
                table: "stages",
                column: "season_id");

            migrationBuilder.CreateIndex(
                name: "IX_substitutions_new_contestant_id",
                table: "substitutions",
                column: "new_contestant_id");

            migrationBuilder.CreateIndex(
                name: "IX_substitutions_old_contestant_id",
                table: "substitutions",
                column: "old_contestant_id");

            migrationBuilder.CreateIndex(
                name: "IX_substitutions_team_id",
                table: "substitutions",
                column: "team_id");

            migrationBuilder.CreateIndex(
                name: "IX_team_members_contestant_id",
                table: "team_members",
